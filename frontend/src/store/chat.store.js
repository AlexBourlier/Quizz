...
export const useChatStore = create((set) => ({
    ...
    setQuizQuestion: (roomId, question, hint, category, difficulty) => set((state) => ({
        quiz: {
            ...state.quiz,
            active: true,
            quizRoomId: roomId,
    ...
    setQuizEnded: () => set((state) => ({ quiz: { ...state.quiz, active: false, quizRoomId: undefined, question: undefined, hint: undefined } })),
