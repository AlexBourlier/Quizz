...
export function App() {
    ...
    if (!isReady) {
        return (_jsx("div", { className: "flex min-h-screen items-center justify-center bg-ink", children: _jsx("div", { className: "h-8 w-8 animate-spin rounded-full border-2 border-sky border-t-transparent" }) }));
    }
