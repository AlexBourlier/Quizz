...
adminRouter.get("/avatars/pending", async (_req, res) => {
...
adminRouter.patch("/avatars/:userId/approve", async (req, res) => {
    try {
...
adminRouter.patch("/avatars/:userId/reject", async (req, res) => {
